...
\begin{thm}[complex spectral theorem]
  ...
  By Schurs theorem, there is an orthonormal basis $e_1, \ddd, e_n$ of $V$ with respect to which $T$ as an upper-triangular matrix. Thus we can write
  \[
    \mmatrix (T, (e_1, \ddd, e_n)) =
    \left(
    \begin{array}{ccc}
      a_{1,1} & \cdots & a_{1,n} \\
              & \ddots & \vdots \\
