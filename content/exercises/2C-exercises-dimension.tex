...
%  \begin{aligned}
%    &0=\underbrace{a_1r_1 +  \cdots + a_{n_{123}} r_{n_{123}}}_{\in \; V_1 \cap V_2 \cap V_3}
%    + \underbrace{b_1v_1 +  \cdots + b_{m_{12}} v_{m_{12}}}_{\text{``extension'' for $V_1 \cap V_2$}}
%    + \underbrace{c_1\widetilde{v}_1 + \cdots + c_{m_{13}}\widetilde{v}_{m_{13}}}_{\text{``extension'' for $V_1 \cap V_3$}}
%    + \underbrace{d_{1}\overline{v}_1 + \cdots + d_{m_{23}}\overline{v}_{m_{23}}}_{\text{``extension'' for $V_2 \cap V_3$}} \\
%    &\quad + \underbrace{e_{1} u_1 + \cdots + e_j u_j }_{\text{``extension'' for $V_1$}}
%    + \underbrace{f_1 w_1 + \cdots + f_k w_k}_{\text{``extension'' for $V_2$}}
%    + \underbrace{g_1 z_1 + \cdots + g_l z_l}_{\text{``extension'' for $V_3$}}.
%  \end{aligned}
%\end{equation}
