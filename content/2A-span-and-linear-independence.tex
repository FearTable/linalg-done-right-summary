...
\begin{prf}
  ...
  So we know, at least $2$ $a$'s are not $0$. Let $k$ be the largest element of $\setonetillm$ such that $a_k \neq 0$. Then
  \begin{equation}
  ...
  Now for the second claim, suppose $k$ is any element of $\setonetillm$ such that $v_k \in \myspan{v_1, \cdots, v_{k-1}}.$ Then we have 
  \begin{equation}
