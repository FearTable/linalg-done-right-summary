...
\end{thm}
\begin{prf}
  \Rightarrowdirection First suppose that $T$ is injective. We already know that $\{0\} \subseteq \mynull T$ because $\mynull T$ is a vector space by \ref{thm: null space is a subspace} or simply by using \ref{thm: linear maps take 0 to 0}. To prove that $\mynull T \subseteq \{0\}$, suppose $v \in \mynull T$. Then
  \[
  ...
  \Leftarrowdirection Now suppose $\mynull T = \{0\}$ and $u,v \in V$ \st $Tu = Tv$. Then
  \[
    0 = Tu - Tv = T(u-v).
  \]
