...
\newcommand{\Rightarrowdirection}{\prooffont{\qt{$\Rightarrow$ direction:} }}
\newcommand{\Leftarrowdirection}{\prooffont{\qt{$\Leftarrow$ direction:} }}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\mdfdefinestyle{proof-style}{
  ...
  hidealllines      = true,
  singleextra       = {
    \draw [thick] (O) -- ++(0,1.8em) (O) -- ++(1.8em,0) ;
    \draw [thick] (P-|O) -- ++(0,-1.8em) (P-|O) -- ++(1.8em,0) ;
  },
  firstextra        = {
    \draw [thick] (P-|O) -- ++(0,-1.8em) (P-|O) -- ++(1.8em,0) ;
  },
...
{\bfseries\scshape}{\underline{\relscale{1.2}#1 {\footnotesize (Chapter \thechapter)}}}{0.5em}{\large}
\titleformat{\section}{\bfseries\scshape}{}{0em}{\underline{{\relscale{1.1}#1} {\footnotesize(Section  \thesection)}}} %Large
\titleformat{\subsection}{\relscale{1.1}\bfseries\scshape}{}{0em}{#1 {\footnotesize (Sub-Section \thesubsection)}} %large
